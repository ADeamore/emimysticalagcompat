...
public class handleemiplugin implements EmiPlugin {
    ...
    public static final EmiStack INFUSION_WORKSTATION = EmiStack.of(ModBlocks.INFUSION_ALTAR.get());
    public static final EmiRecipeCategory INFUSION_CATEGORY
            = new EmiRecipeCategory(new ResourceLocation("mysticalagriculture", "infusion"), INFUSION_WORKSTATION, new EmiTexture(INFUSION_SPRITE, 0, 0, 16, 16));
